...
<script>
	...
	function callBack()
	{
		...
		// XML 문서의 최상위 엘리먼트 수신(루트 엘리먼트) → 지금은 <list>인 상황
		var root = doc.documentElement;
		
		// 루트 엘리먼트를 활용하여 구조적 접근
		//-- 모든 <item> 엘리먼트 수신
		...
		// 최종적으로 목록을 화면에서 보일 수 있도록 처리하기 → 스타일 적용
